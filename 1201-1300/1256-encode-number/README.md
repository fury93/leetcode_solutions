<h2><a href="https://leetcode.com/problems/encode-number">Encode Number</a></h2> <img src='https://img.shields.io/badge/Difficulty-Medium-orange' alt='Difficulty: Medium' /><hr><p>Given a non-negative integer <code>num</code>, Return its <em>encoding</em> string.</p>
