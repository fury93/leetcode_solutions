<h2><a href="https://leetcode.com/problems/palindrome-removal">Palindrome Removal</a></h2> <img src='https://img.shields.io/badge/Difficulty-Hard-red' alt='Difficulty: Hard' /><hr><p>You are given an integer array <code>arr</code>.</p>
