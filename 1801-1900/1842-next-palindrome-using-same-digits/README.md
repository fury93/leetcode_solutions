<h2><a href="https://leetcode.com/problems/next-palindrome-using-same-digits">Next Palindrome Using Same Digits</a></h2> <img src='https://img.shields.io/badge/Difficulty-Hard-red' alt='Difficulty: Hard' /><hr><p>You are given a numeric string <code>num</code>, representing a very large <strong>palindrome</strong>.</p>
