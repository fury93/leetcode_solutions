<h2><a href="https://leetcode.com/problems/subtree-removal-game-with-fibonacci-tree">Subtree Removal Game with Fibonacci Tree</a></h2> <img src='https://img.shields.io/badge/Difficulty-Hard-red' alt='Difficulty: Hard' /><hr><p>A <strong>Fibonacci</strong> tree is a binary tree created using the order function <code>order(n)</code>:</p>
