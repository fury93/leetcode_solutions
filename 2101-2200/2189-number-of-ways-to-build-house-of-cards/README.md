<h2><a href="https://leetcode.com/problems/number-of-ways-to-build-house-of-cards">Number of Ways to Build House of Cards</a></h2> <img src='https://img.shields.io/badge/Difficulty-Medium-orange' alt='Difficulty: Medium' /><hr><p>You are given an integer <code>n</code> representing the number of playing cards you have. A <strong>house of cards</strong> meets the following conditions:</p>
